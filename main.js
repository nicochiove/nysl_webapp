...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function showNextMatch(){//MUESTRA EL PROXIMO PARTIDO EN EL CAROUSEL
		...
		if(next_match != undefined){
			...
			let str= `	<p><h4>${next_match.teams}</h4></p>
						<p><h5>${app.valid_days[(next_match.formatedDate.getDay())]}</h5></p>
						<p><h5>${next_match.formatedDate.getHours()}:${next_match.formatedDate.getMinutes()}</h5></p>`
